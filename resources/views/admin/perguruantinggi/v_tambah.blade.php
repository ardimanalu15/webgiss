...
<div class="col-md-12">
    <div class="card card-outline card-primary">
        ...
        <!-- /.card-header -->
        <form action="/perguruantinggi/insert" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="card-body">
                <div class="row">
                    <div class="col-sm-12">
                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="form-group">
                            <label>Posisi</label>
                            <input type="text" name="posisi" id="posisi" class="form-control" placeholder="Posisi Perguruan Tinggi" >
                            <div class="text-danger">
                                @error('posisi')
                                {{ $message}}
                                @enderror
